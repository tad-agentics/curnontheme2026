...
<div class="count">
    <div class="count-btn count-minus"> <i class="fas fa-minus icon"></i>
    </div>

    <input type="text" id="<?php echo esc_attr($input_id); ?>"
        class="<?php echo esc_attr(join(' ', (array) $classes)); ?> count-input" step="<?php echo esc_attr($step); ?>"
        ...
        autocomplete="<?php echo esc_attr(isset($autocomplete) ? $autocomplete : 'on'); ?>" hidden />

    <p class="count-number"><?php if(esc_attr($input_value) < 10){ echo '0'; } ?><?php echo esc_attr($input_value); ?>
    </p>
    <div class="count-btn count-plus"> <i class="fas fa-plus icon"></i>
    </div>
</div>
